...
class PantoGraph:
    ...
    def __init__(
        ...
        # box_bounds=(-3, -3, 3, 3),
        # box_bounds=(-1,6, 1, 7), # Range of (left x, bottom y, right x, top y)
        box_bounds=(6,-1,7,1), # Range of (bottom y, left x, top y, right x)
        ...
        # print("BOUNDS[0] = ", box_bounds[0])
        # print("BOUNDS[1] = ", box_bounds[1])
        # print("BOUNDS[2] = ", box_bounds[2])
        # print("BOUNDS[3] = ", box_bounds[3])
...
--------------------------------------------------------- \n""")
    ...
    def plot_lines(self, lines=[], wait=.1, interpolate=10, rotate=False, bounds=None):
        ...
        print("FIRST min_x, max_x = ",min_x, max_x)
        print("FIRST min_y, max_y = ",min_y, max_y)
        ...
        for i in range(len(lines)):
            ...
            for j in range(len(line)):
                ...
                y = point[1]                
                y = y - y_mid_point         # shift y values so that they have zero as their mid-point
                y = y / divider             # scale y values to fit in our box width
                y = y + box_y_mid_point     # shift y values so that they have the box x midpoint as their endpoint
        ...
        #########################################################################################################################
        # NOTE: This section is for dev. purposes only. delete when time to run!
