...
class MotorController:
   ...
   def pen_up(self):
      self.up_down_servo.angle = 70
      print("Pen is up. Rear servo at 70 degrees")

   def pen_down(self):
      self.up_down_servo.angle = 90
      print("Pen is down. Rear servo at 90 degrees")

   def angles_to_pwm(self, servo, angle):
      servo.angle = angle
      if (servo == self.left_servo):
         print("Left servo moved to " + str(angle))
      else:
         print("Right servo moved to " + str(angle))
      # sleep(2)
   ...
   def plot_angles(self, angles, wait=1.31):
      ...
      self.pen_up() # Put the pen up at the end
